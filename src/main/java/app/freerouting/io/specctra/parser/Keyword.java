...
public class Keyword {
  ...
  public static final Keyword AUTOROUTE_SETTINGS = new Keyword("autorouteSettings");
  ...
  public static final Keyword CLEARANCE_CLASS = new Keyword("clearanceClass");
  ...
  public static final Keyword LOGICAL_PART = new Keyword("logicalPart");
  ...
  public static final Keyword SNAP_ANGLE = new Keyword("snapAngle");
  ...
  public static final Keyword PULL_TIGHT = new Keyword("pullTight");
  ...
  public static final Keyword SHOVE_FIXED = new Keyword("shoveFixed");
  ...
  public static final Keyword START_RIPUP_COSTS = new Keyword("startRipupCosts");
  public static final Keyword STRING_QUOTE = new Keyword("stringQuote");
  public static final ScopeKeyword STRUCTURE_SCOPE = new Structure();
  public static final Keyword TYPE = new Keyword("type");
  public static final Keyword USE_LAYER = new Keyword("useLayer");
  public static final Keyword USE_NET = new Keyword("use_net");
  public static final Keyword USE_VIA = new Keyword("useVia");
  ...
  public static final Keyword VIA_COSTS = new Keyword("viaCosts");
  public static final Keyword VIA_KEEPOUT = new Keyword("via_keepout");
  public static final Keyword VIA_RULE = new Keyword("viaRule");
